...
function createWarnFailed() {
    ...
    var textNode = document.createTextNode("Action Failed!");
    warnDelete.appendChild(textNode);
...
function createWarnIssued() {
    ...
    var textNode = document.createTextNode("Item Issued Successfully!");
    warnDelete.appendChild(textNode);
