...
<?php include './component/warning.php' ?>
<div class="fixed z-10 w-full h-full bg-black bg-opacity-40 items-center hidden" id="modalbg">
    <form method="post" action="" id="modal"
        ...
        <div class="mb-6 w-full">
            <label for="spool" class="block mb-2 text-sm font-medium text-gray-900">Spool No.*</label>
            <div class="w-full flex">
                <input type="text" id="spoolSearch" oninput="searchSpool()" placeholder="Spool"
                ...
                <div class="right-0 w-[60%]">
                    <select name="spool" id="spool" onchange="getIC()"
                        class="bg-gray-50 border border-gray-300 text-gray-600 font-semibold text-sm rounded-r-lg focus:outline-0 focus:ring-inset focus:ring-2 focus:ring-[#2E3192] focus:border-[#2E3192] block w-full p-2.5 hover:cursor-not-allowed"
                        required>
                    </select>
                </div>
            </div>
        ...
        <div class="w-full flex justify-between mb-3">
            <div class="w-full mr-1">
                ...
                <input name="qty" type="text" id="qty"
                    ...
                    placeholder="" oninput="warning()" required />
            </div>
            <div class="w-full ml-1">
                <label for="by" class="block mb-2 text-sm font-medium text-gray-900">Fitter *</label>
    ...
    <div class="mb-3 fixed z-10 w-full h-full bg-black bg-opacity-20 items-center hidden"
        id="newID">
        <form action="../uploaded/excel_Issued.php" method="post" enctype="multipart/form-data" id="uploadForm"
            ...
            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
            <div class="mb-3 flex font-semibold p-3 text-white w-full h-max bg-red-500 hover:bg-red-400 rounded-md items-center justify-evenly transition-all duration-200 ease-in-out">
                <div class="w-[93%]">
                    <h4 class="w-full text-center border-b border-b-white mb-2">WARNING!</h4>
                    <div class="text-sm font-normal text-justify">You will be making <strong>changes to all existing data in the table</strong>. Therefore, please ensure that you have downloaded all the existed data and modified it according to your needs! Also, make sure that the column headers comply with the specified requirements.</div>
                </div>
            </div>
