        ...
        <form class="flex flex-col gap-3 bg-white w-[90%] md:w-1/2 lg:w-1/4 rounded px-8 p-6 shadow">
            ...
            <div class="w-full">
              ...
              <div class="w-full flex">
                <input required type="text" id="identCode" class="w-1/2 px-3 py-1 outline-none rounded-s border focus:border-[#3f43bd]">
                <select id="identCodeOption" class="w-1/2 px-3 py-1 outline-none rounded-e border focus:ring focus:ring-[#3f43bd]">
                  <option value=""></option>
                  <option value=""></option>
                  <option value=""></option>
                  <option value=""></option>
