    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_FILES['excelFile']) && $_FILES['excelFile']['error'] === UPLOAD_ERR_OK) {
            ...
            foreach ($realdata as $item) {
                ...
                $query = "INSERT INTO `$db` (batch, IDENT_CODE, bm_qty) VALUES ('$batch', '$identCode', '$qty')";
